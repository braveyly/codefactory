...
cp_rbnode *cp_rbnode_create(void *key, void *value);
...
typedef struct _cp_rbtree
{
	...
	cp_mapping_cmp_fn map_cmp;   /* mapping comparison function for multiple
									value entry deletion */
